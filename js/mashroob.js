// Mashroob Page JavaScript - Accompaniments
...
function initScrollAnimations() {
    const animateElements = document.querySelectorAll('.intro-content, .feature, .section-header, .menu-item, .special-item, .pairing-item, .contact-content');
