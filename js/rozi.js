// Rozi Page JavaScript - Daily Specials
...
function initScrollAnimations() {
    const animateElements = document.querySelectorAll('.intro-content, .feature, .section-header, .menu-item, .special-item, .highlight-item, .contact-content');
